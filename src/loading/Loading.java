...
public class Loading extends javax.swing.JFrame implements Runnable{
        ...
        try{
            for (int i = 1; i <= 200; i++) {
                ...
                else
                {
                    ...
                    //setVisible(false);
                    dispose();
                    new library.Home().setVisible(true);
                }
                Thread.sleep(50);
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setForeground(new java.awt.Color(29, 29, 217));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logo.jpg"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel1.setText("Loading...");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/animated-book-image-0005.gif"))); // NOI18N
